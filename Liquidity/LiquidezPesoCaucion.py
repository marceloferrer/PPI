### Automatically invest the liquidity of the account in pesos at the end of the day in cauciones
    ...
    try:
        ...
        if diasemana != 5 and diasemana != 6:
            ...
            if amount > 1000:
                # Si es viernes
                if diasemana == 4:
                    tickercaucion = "PESOS3"
                else:
                    tickercaucion = "PESOS1"
                    
                msg = ppi.marketdata.current(SearchMarketData(tickercaucion, "CAUCIONES", "INMEDIATA"))
                precio = msg['price']
                print("Tasa de caucion en %s %s" % (tickercaucion, precio))
                
                # Get budget
                print("\nGet budget")
                budget = ppi.orders.budget(OrderBudget(account_number, amount, precio, tickercaucion, "CAUCIONES",
                ...
                confirmation = ppi.orders.confirm(OrderConfirm(account_number, amount, precio, tickercaucion, "CAUCIONES",
